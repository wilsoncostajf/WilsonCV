...
select count(idVenda) as 'Quantidade de Vendas do Dia' , sum(valor) as 'Renda Bruta' , data as 'Data'
from venda
group by data;
...
select  quantidade, idProduto, nome, valorVenda as 'Valor', quantidade * valorVenda as 'Renda Bruta'
from produtos
order by quantidade 
limit 10;
